...
describe('grabSNILS', () => {
  ...
  it('returns the first SNILS it finds', () => {
    let SNILS = grabSNILS('The numbers are 350-802-074 94, 234-600-142 22, and 013-605-876 94');
...
describe('grabAllSNILS', () => {
  it('returns a collection of all the SNILS if it finds any SNILS', () => {
    ...
    expect(allSNILS).toEqual(['350-802-074 94', '234-600-142 22', '013-605-876 94'])
  })
...
describe('hideAllSNILS', () => {
  it('hides any SNILS it finds', () => {
    ...
    expect(hiddenSNILS).toEqual('The numbers are XXX-XXX-XXX 94, XXX-XXX-XXX 22, and XXX-XXX-XXX 94')
  })
...
describe('formatSNILS', () => {
  it('formats any SNILS it finds', () => {
    ...
    expect(formattedSNILS).toEqual('The numbers are 350-802-074 94, 234-600-142 22, and 013-605-876 94');
  })
